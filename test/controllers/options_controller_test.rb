...
class OptionsControllerTest < ActionController::TestCase
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post :create, option: { key: @option.key, museum_id: @option.museum_id, name: @option.name, value: @option.value }
    end
  ...
  test "should update option" do
    patch :update, id: @option, option: { key: @option.key, museum_id: @option.museum_id, name: @option.name, value: @option.value }
    assert_redirected_to option_path(assigns(:option))
  end
